...
from .views import about, PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, \
       PostLikeView, CommentView, CommentDeleteView, CommentUpdateView, FollowingUserListView, CommentReplyView
...
urlpatterns = [
       ...
       path("post/comment/<int:pk>/reply", CommentReplyView.as_view(), name='comment-reply'),
